...
func (_m *TaskRepository) Create(ctx context.Context, task *domain.Task) (*domain.Task, error) {
...
func (_m *TaskRepository) Update(ctx context.Context, task *domain.Task) (*domain.Task, error) {
	ret := _m.Called(ctx, task)
